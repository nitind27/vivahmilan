...
const ARTICLES = [
  ...
  },
  {
    ...
    answer: {
      en: `📝 **How to Register**\n\n1. Open [Register](/register)\n2. Enter **name, email, password**, phone & gender\n3. Verify email with **OTP** sent to your inbox\n4. Complete **onboarding** (profile details + photo + ID)\n5. Submit for **admin review** (usually within 24 hours)\n6. After approval → login and start matching!\n\n⚠️ Use a valid email — OTP goes there only (no SMS OTP).`,
      hi: `📝 **रजिस्टर कैसे करें**\n\n1. [Register](/register) खोलें\n2. **नाम, ईमेल, पासवर्ड**, फोन और लिंग भरें\n3. ईमेल पर **OTP** verify करें\n4. **Onboarding** पूरा करें (प्रोफाइल + फोटो + ID)\n5. **Admin review** के लिए submit करें (24 घंटे)\n6. Approval के बाद login करें!\n\n⚠️ OTP सिर्फ email पर — SMS OTP नहीं है।`,
    },
  ...
  },
  {
    ...
    answer: {
      en: `📧 **Email OTP Verification**\n\n• OTP is sent to your **registered email only** (no SMS)\n• Check **Spam/Junk** folder\n• Wait 2–3 minutes, click Resend OTP\n• Use correct email from registration\n\nStill stuck? Try [Forgot Password](/forgot-password) or connect live agent.`,
      hi: `📧 **Email OTP**\n\n• OTP sirf **email** par (SMS nahi)\n• **Spam** folder check karo\n• 2–3 min wait, Resend dabao\n• Sahi email use karo`,
    },
  ...
  },
  {
    ...
    answer: {
      en: `📞 **Contact Support**\n\n• Email: **support@vivahmilan.com**\n• Refunds: **refunds@vivahmilan.com**\n• [Contact Page](/contact)\n• [Help Center](/help) — full FAQ\n• Live agent: type **"talk to agent"** here\n\nWe typically respond within 24 hours.`,
      hi: `📞 **Contact**\n\n• **support@vivahmilan.com**\n• [Contact](/contact) · [Help](/help)\n• Yahan **"talk to agent"** likho live chat ke liye`,
    },
  ...
  },
  {
    ...
    answer: {
      ...
      hi: `🧑‍💼 **Human Support...**\n\nआपको agent से जोड़ रहे हैं। नीचे issue लिखें।\n\n📧 **support@vivahmilan.com**\n📋 [Contact](/contact)`,
    },
  },
  {
    id: 'refund',
