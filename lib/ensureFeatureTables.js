...
export async function ensureFeatureTables() {
  if (!ensured) {
    ...
    await ensureColumn('user', 'profileCorrectionRequired', 'TINYINT(1) DEFAULT 0');
    await ensureColumn('user', 'profileCorrectionNote', 'TEXT NULL');
    await ensureColumn('user', 'profileCorrectionFields', 'TEXT NULL');
    await ensureColumn('user', 'profileCorrectionRequestedAt', 'DATETIME NULL');
    await ensureColumn('user', 'profileCorrectionToken', 'VARCHAR(64) NULL');
    await ensureColumn('user', 'isSeedProfile', 'TINYINT(1) NOT NULL DEFAULT 0');
