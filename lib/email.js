...
export async function sendAdminVerificationEmail(email, name) {
  await transporter.sendMail({
    from: FROM,
    to: email,
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:40px 32px;text-align:center;">
          ...
          <p style="color:#6b7280;margin:0 0 24px;">Hi ${name}, your Milan Matrimony profile has been verified by our team. You can now login and start finding your perfect match!</p>
