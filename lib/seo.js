...
export const BRAND = {
  ...
  alternateNames: ['Vivah Dwar', 'Milan Matrimony', 'Vivah Dwar Matrimonial', 'Vivah Dwar Matrimonial'],
  tagline: 'Find Love · Find Your Life Partner',
  description:
    'Vivah Dwar (Vivah Dwar) is India\'s trusted matrimonial platform — verified profiles, smart matchmaking, and secure chat to find love and your perfect life partner for marriage.',
...
export const rootLayoutMetadata = {
  ...buildPageMetadata({
    title: `${BRAND.name} – India's Trusted Matrimonial Site | Vivah Dwar | Find Love`,
    description: BRAND.description,
    path: '/',
  }),
  title: {
    default: `${BRAND.name} – India's Trusted Matrimonial Site | Vivah Dwar | Find Love`,
...
export const homeMetadata = buildPageMetadata({
  title: `${BRAND.name} – #1 Matrimonial Website | Vivah Dwar | Find Love & Life Partner`,
  description:
    'Join Vivah Dwar (Vivah Dwar) — premium Indian matrimonial site with verified profiles, AI matchmaking & secure chat. Find love, shaadi & your perfect vivah partner. Register free today.',
  path: '/',
  keywords: [
...
export const loginMetadata = buildPageMetadata({
  title: `Login – ${BRAND.name} Matrimonial | Vivah Dwar Member Sign In`,
  description: `Sign in to ${BRAND.name} (Vivah Dwar) — access verified matrimonial profiles, matches, chat & find your life partner.`,
  path: '/login',
});

export const registerMetadata = buildPageMetadata({
  title: `Free Registration – ${BRAND.name} | Vivah Dwar Matrimonial`,
  description: `Create your free ${BRAND.name} matrimonial profile. Verified members, smart matching — find love & marriage partner on India's trusted Vivah Dwar platform.`,
  path: '/register',
...
export const storiesMetadata = buildPageMetadata({
  ...
  description: `Real marriage success stories from ${BRAND.name} & Vivah Dwar members — inspiration for your matrimonial journey.`,
  path: '/stories',
});
...
export const helpMetadata = buildPageMetadata({
  ...
  description: `FAQs for ${BRAND.name} (Vivah Dwar) — account, matching, premium plans, safety & matrimonial features.`,
  path: '/help',
});
...
export function getMatrimonialServiceSchema() {
  return {
    ...
    alternateName: ['Vivah Dwar Matrimonial', 'Vivah Dwar Shaadi'],
    description: BRAND.description,
    url: SITE_URL,
