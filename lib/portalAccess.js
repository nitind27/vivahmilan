...
/**
 * Live portal gate (not stale JWT).
 * Pass `req` in middleware so Edge can call /api/portal-access with session cookies.
 */
export async function isPortalBlockedForToken(token, req = null) {
