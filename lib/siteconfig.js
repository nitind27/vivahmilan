...
const DEFAULTS = {
  ...
  app_nav_enabled: '1',
  donation_enabled: '0',
  homepage_stats_mode: 'live', // live = real DB counts on homepage; manual = custom display from homepage_stat
  ...
  login_email_enabled: '1', // 1 = email/password form on /login
  login_qr_enabled: '1', // 1 = QR code login option on /login
  login_google_enabled: '1', // 1 = Continue with Google on /login
  login_family_enabled: '1', // 1 = Family Login tab on /login
};
