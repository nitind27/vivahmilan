...
/** Log login geo to admin panel after successful web login (requires functional cookie consent). */
export async function logWebLogin() {
  if (typeof window !== 'undefined' && hasConsentChoice() && !acceptsFunctional()) return;
  try {
